...
// 转译残留兜底（包内裸引用——无 import 的 eval 面——全局自注册）
if (typeof globalThis.dshHomePath === 'undefined') globalThis.dshHomePath = dshHomePath;
if (typeof globalThis.resolveDshHome === 'undefined') globalThis.resolveDshHome = resolveDshHome;
