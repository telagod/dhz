...
//#endregion
// M-5 补丁：nullable（NM 596 行版本缺此 API——DSH 依赖面需要；optional 补丁同步）
if (!Schema.prototype.nullable) Schema.prototype.nullable = function nullable() { this.meta.nullable = true; return this; };
if (!Schema.prototype.optional) Schema.prototype.optional = function optional() { this.meta.required = false; return this; };
