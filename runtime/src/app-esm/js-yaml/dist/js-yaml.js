(function(global, factory) {
    ...
    var FAILSAFE_SCHEMA = yaml.FAILSAFE_SCHEMA;
    var JSON_SCHEMA = yaml.JSON_SCHEMA;
    var CORE_SCHEMA = yaml.CORE_SCHEMA;
    var DEFAULT_SCHEMA = yaml.DEFAULT_SCHEMA;
    var load = yaml.load;
    var loadAll = yaml.loadAll;
    var dump = yaml.dump;
    var YAMLException = yaml.YAMLException;
    var types = yaml.types;
    var safeLoad = yaml.safeLoad;
    var safeLoadAll = yaml.safeLoadAll;
    var safeDump = yaml.safeDump;
